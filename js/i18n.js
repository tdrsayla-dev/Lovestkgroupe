...
const translations = {
  ...
  'en': {
    ...
    menu_expense_vouchers: 'Expense Vouchers',
    menu_general_ledger: 'General Ledger',
    menu_invoices: 'Invoices & Revenue',
    ...
    Currency: 'Currency',
    CURRENCY: 'Currency',
    enter_title: 'Enter title / subject...',
    enter_description: 'Enter description / details...',
    ...
    stat_late_hrs: 'Late (Mins)',
    stat_early_hrs: 'Early (Mins)',
    stat_early_in_hrs: 'Early In (Mins)',
    stat_late_out_hrs: 'Late Out (Mins)',
    stat_net_offset_hrs: 'Net Offset (Mins)',
    stat_absent: 'Absent',
    stat_ot_amount: 'OT Amount',
    btn_ot_settings: 'OT Rules',
    ot_settings_title: 'Overtime (OT) Rules & Settings',
    ot_settings_desc: 'Configure OT rules for Sunday shifts and overtime calculation',
    sunday_ot_rule: 'Sunday OT Rule (Weekend Scan)',
    ...
    dash_checkin_title: 'Check-IN',
    dash_absent_title: 'Absent Details',
    dash_leave_title: 'Leave Requests',
    dash_assets: 'Assets',
    dash_late_hrs: 'Late (Hrs)',
    dash_absent_stat: 'Absent',
    dash_early_leave_hrs: 'Early Leave (Hrs)',
    dash_ot_amount_stat: 'OT Amount',
    btn_approve: 'Approve',
    btn_reject: 'Reject',
  ...
  'la': {
    ...
    no_pending_leaves: 'ບໍ່ມີລາຍການລໍຖ້າອະນຸມັດ',
    dept_all: 'ທັງໝົດ',
    dept_tab_title: 'ພະແນກ',
    ...
    menu_chart_of_accounts: 'ຜັງບັນຊີ (Chart of Accounts)',
    menu_expense_vouchers: 'ບັນທຶກຄ່າໃຊ້ຈ່າຍ (Expense Vouchers)',
    menu_general_ledger: 'ປື້ມບັນຊີປະຈຳວັນທົ່ວໄປ (General Ledger)',
    menu_invoices: 'ໃບແຈ້ງໜີ້ ແລະ ລາຍຮັບ (Invoices)',
    menu_financial_reports: 'ລາຍງານทางการເງິນ (Financial Reports)',
    ...
    title_label: 'ຫົວຂໍ້ / ຈຸດປະສົງ',
    description_label: 'ລາຍລະອຽດ / ເຫດຜົນ',
    amount_label: 'ຈຳນວນເງິນ',
    request_date_label: 'ວັນທີຂໍອະນຸມັດ',
    Title: 'ຫົວຂໍ້',
    TITLE: 'ຫົວຂໍ້',
    ...
    Amount: 'ຈຳນວນເງິນ',
    AMOUNT: 'ຈຳນວນເງິນ',
    Request_Date: 'ວັນທີຂໍອະນຸມັດ',
    REQUEST_DATE: 'ວັນທີຂໍອະນຸມັດ',
    Items: 'ລາຍການ',
    ITEMS: 'ລາຍການ',
    Currency: 'ສະກຸນເງິນ',
    CURRENCY: 'ສະກຸນເງິນ',
    enter_title: 'ປ້ອນຫົວຂໍ້ / ຈຸດປະສົງ...',
    enter_description: 'ປ້ອນລາຍລະອຽດ...',
    ...
    stat_late_hrs: 'ມາຊ້າ (ນາທີ)',
    stat_early_hrs: 'ກັບກ່ອນ (ນາທີ)',
    stat_early_in_hrs: 'ມາກ່ອນເວລາ (ນາທີ)',
    stat_late_out_hrs: 'ຢູ່ຫຼັງເລີກວຽກ (ນາທີ)',
    stat_net_offset_hrs: 'ເວລາສຸທິ / ຫັກລົບ (ນາທີ)',
    stat_absent: 'ຂາດການ',
    stat_ot_amount: 'ຈຳນວນເງິນ OT',
    btn_ot_settings: 'ເງື່ອນໄຂ OT',
    ot_settings_title: 'ຕັ້ງຄ່າເງື່ອນໄຂການໃຫ້ OT',
    ot_settings_desc: 'ກຳນົດເງື່ອນໄຂ OT ວັນອາທິດ ແລະ ການຄຳນວນລ່ວງເວລາ',
    sunday_ot_rule: 'ເງື່ອນໄຂ OT ວັນອາທິດ (Sunday OT)',
    ...
    dash_checkin_title: 'ເຂົ້າວຽກແລ້ວ',
    dash_absent_title: 'ລາຍລະອຽດຂາດວຽກ',
    dash_leave_title: 'ຄຳຮ້ອງຂໍລາພັກ',
    dash_assets: 'ຊັບສິນ',
    dash_late_hrs: 'ມາຊ້າ (ຊ.ມ.)',
    dash_absent_stat: 'ຂາດວຽກ',
    dash_early_leave_hrs: 'ກັບກ່ອນ (ຊ.ມ.)',
    dash_ot_amount_stat: 'ຈຳນວນເງິນ OT',
    btn_approve: 'ອະນຸມັດ',
    btn_reject: 'ປະຕິເສດ',
    change_status: 'ປ່ຽນສະຖານະ...',
    days_unit: 'ມື້',
    confirm_approve: 'ຢືນຢັນອະນຸມັດ',
  ...
  'th': {
    ...
    no_pending_leaves: 'ไม่มีรายการรออนุมัติ',
    dept_all: 'ทั้งหมด',
    dept_tab_title: 'แผนก',
    ...
    title_label: 'หัวข้อ / วัตถุประสงค์',
    description_label: 'รายละเอียด / เหตุผล',
    amount_label: 'จำนวนเงิน',
    request_date_label: 'วันที่ขออนุมัติ',
    Title: 'หัวข้อ',
    TITLE: 'หัวข้อ',
    ...
    Amount: 'จำนวนเงิน',
    AMOUNT: 'จำนวนเงิน',
    Request_Date: 'วันที่ขออนุมัติ',
    REQUEST_DATE: 'วันที่ขออนุมัติ',
    Items: 'รายการ',
    ITEMS: 'รายการ',
    Currency: 'สกุลเงิน',
    CURRENCY: 'สกุลเงิน',
    enter_title: 'กรอกหัวข้อ / วัตถุประสงค์...',
    enter_description: 'กรอกรายละเอียด...',
    ...
    stat_late_hrs: 'มาสาย (นาที)',
    stat_early_hrs: 'กลับก่อน (นาที)',
    stat_early_in_hrs: 'มาก่อนเวลา (นาที)',
    stat_late_out_hrs: 'อยู่หลังเลิกงาน (นาที)',
    stat_net_offset_hrs: 'เวลาสุทธิ / หักลบ (นาที)',
    stat_absent: 'ขาดงาน',
    stat_ot_amount: 'ยอดรวมค่า OT',
    btn_ot_settings: 'เงื่อนไข OT',
    ot_settings_title: 'ตั้งค่าเงื่อนไขการให้ OT',
    ot_settings_desc: 'กำหนดเงื่อนไข OT วันอาทิตย์ และการคำนวณล่วงเวลา',
    sunday_ot_rule: 'เงื่อนไข OT วันอาทิตย์ (สแกนเข้างานวันอาทิตย์)',
    dash_checkin_title: 'เข้างานแล้ว',
    dash_absent_title: 'รายละเอียดขาดงาน',
    dash_leave_title: 'คำขอลาพักงาน',
    dash_assets: 'ทรัพย์สิน',
    dash_late_hrs: 'มาสาย (ชม.)',
    dash_absent_stat: 'ขาดงาน',
    dash_early_leave_hrs: 'กลับก่อน (ชม.)',
    dash_ot_amount_stat: 'ยอดรวมค่า OT',
    btn_approve: 'อนุมัติ',
    btn_reject: 'ปฏิเสธ',
